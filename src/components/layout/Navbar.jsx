            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <Link to="/" className="flex items-center gap-2">
                        <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-600 rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-primary-500/30">
                            DJ
                        </div>
                        <span className="font-heading font-bold text-xl sm:text-2xl text-neutral-900 tracking-tight">
                            Divya Jyoti <span className="text-primary-600">NGO</span>
                        </span>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        ...
                        >
                            <Heart className="w-4 h-4 fill-white/20 group-hover:fill-white/40 transition-colors" />
                            Donate Now
                        </Link>
                    </div>
